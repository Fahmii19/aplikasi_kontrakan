    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            ...
            <div class="custom-breadcrumb ml-auto">
                ...
                <a href="<?php echo base_url('admin/data_pemilik_kontrakan') ?>" class="breadcrumb"><?= $title ?></a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-content">
                       ...
                       <form class="h-form r-separator" method="post" action="<?php echo base_url('admin/input_data_pemilik')?>">
                        <div class="form-body">
                            <div class="card-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s10">
                                        <input type="text" name="nama_pemilik_kontrakan" placeholder="Nama">
                                    </div>
                                </div>
